...
--------------------------------------
There are many environment variables that you can set in Firefly III. Just check out the `default env file <https://github.com/firefly-iii/firefly-iii/blob/master/.deploy/docker/.env>`_ that lists them all. 
