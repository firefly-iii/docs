...
You should have one asset [account](../financial-concepts/accounts.md) per actual account that you have. If your bank supports sub-accounts, you can also make asset accounts for those.
...
Use tags to be judgy about your expenses. I have a tag `bad buy 2026`, and similar tags for previous years. As you can imagine, I track my bad buys using this tag. It's also possible to use the [product manager](https://github.com/JC5/product-manager/) or similar tools to organize your data in tags.
