...
Please refrain from submitting issues or pull requests generated by fully-automated tools. I reserve the right, at my sole discretion, to close such submissions and to block any account responsible for them.

Review all code or documentation changes made by AI tools and make sure you understand all changes and can explain them on request, before submitting them under your name. Do not submit any AI-generated code that you haven't personally reviewed, understood and tested, as this wastes my time.
...
[Credits for this policy](https://scikit-learn.org/stable/developers/contributing.html#automated-contributions-policy)
