...
## Budgets and displaying amounts in your primary currency

Even when you convert all your amounts to your primary currency, the behavior of budgets does not change. 
