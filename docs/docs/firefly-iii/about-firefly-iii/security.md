...
- Firefly III can *optionally* submit telemetry data to [telemetry.firefly-iii.org](https://telemetry.firefly-iii.org). Read more about [telemetry](../support/telemetry.md). This is a Linux machine hosted on Azure, proxied by Cloudflare.
